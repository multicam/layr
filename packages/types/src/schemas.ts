 ...
 * Schemas are the single source of truth for JSON structure.
 * TypeScript types are derived from or validated against these schemas.
 */

import { z } from 'zod';
import type { Formula, ActionModel } from './index';
...
export const ValueOperationSchema = z.object({
...
export const PathOperationSchema = z.object({
  type: z.literal('path'),
...
const SetURLParametersActionSchema = ActionModelBase.extend({
